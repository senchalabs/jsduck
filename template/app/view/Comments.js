        ...
        var commentMetaAndGuide = [
            ...
            '<div class="commentGuideTxt" style="display: none">',
                '<ul>',
                    ...
                    '<li>For any <em>questions</em> about code or usage, please use the <a href="http://developer.appcelerator.com/questions" target="_blank">Q&A</a>.</li>',
                ...
                '</div>',
                '<ul>',
                    '<li>Links will only work if they start with <code>#!/</code>',
                '</ul>',
            '</div>'
        ];
            ...
            '<div class="new-comment{[values.hide ? "" : " open"]}">',
                '<form class="newCommentForm">',
                    ...
                    '<div class="note problem" style="display: none;">',
                        ...
                        '</ul>',
                        '<p>For <b>SDK bugs</b>, please use the forums.<br />',
                    ...
                    '<div class="note feedback" style="display: none;">',
                        '<p>Your feedback will <b>not appear</b> online and you are unlikely to receive a personal response. ',
                            'However feedback is monitored closely by the Documentation team.</p>',
