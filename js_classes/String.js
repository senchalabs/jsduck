...
/**
 * @property N
 * Used to access the character in the _N_th position where _N_ is a positive integer between 0 and one 
 * less than the value of length. These properties are read-only.
 */
